...
$routes[] = array('uri' => "/^\/(?<controller>record)\/(?<action>delete)\/(?<table>[a-z_0-9]+)\/(?<id>[a-zA-Z_0-9]+)$/");
$routes[] = array('uri' => "/^\/(?<controller>record)\/(?<action>processdelete)\/(?<table>[a-z_0-9]+)\/(?<id>[a-zA-Z_0-9]+)$/");
